 ...
 */
public class SelectedSettingsDialog extends javax.swing.JDialog {

    private double traceWidth, ringDiam, holeDiam;
    private boolean cancelled;

    /**
     * Creates new form NewProjectDialog
     */
    public SelectedSettingsDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void okBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okBtnActionPerformed
        try {
            traceWidth = widthTxtField.getText().isEmpty() 
                    ? 0.0 : Double.parseDouble(widthTxtField.getText());
            ringDiam = ringDiamTxtField.getText().isEmpty() 
                    ? 0.0 : Double.parseDouble(ringDiamTxtField.getText());
            holeDiam = holeDiamTxtField.getText().isEmpty() 
                    ? -0.01 : Double.parseDouble(holeDiamTxtField.getText());
            
            // Check that the hole diameter is smaller than the annular ring.
            if(holeDiam >= ringDiam) {
                JOptionPane.showMessageDialog(this, "Hole diameter must be "
                        + "smaller than the annular ring diameter!", "Error", 
            ...
            // Set the text color red upon error.
